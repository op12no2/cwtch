...
- datagen | dg _dir_ _positions_ - write self-play games to _dir_ in viriformat for a total of _positions_ positions. see also ```bin/datagen```. Configure using the constants in ```src/datagen.c```.
